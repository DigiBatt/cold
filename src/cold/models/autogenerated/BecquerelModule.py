...
class Becquerel(FrequencyUnit, SISpecialUnit):
    """
    Class representing the `Becquerel` entity, which inherits from:
    - FrequencyUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Becquerel'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'Becquerel'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#Becquerel',
    
    class_name='Becquerel',
