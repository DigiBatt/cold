...
class NeonAtom(Declared, Atom):
    """
    Class representing the `NeonAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_24e7961c_26c8_5ae1_a29c_c32717c40684'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NeonAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_24e7961c_26c8_5ae1_a29c_c32717c40684',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_24e7961c_26c8_5ae1_a29c_c32717c40684',
        alias="class_iri"
    )
