...
class ArsenicAtom(Declared, Atom):
    """
    Class representing the `ArsenicAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_41dba862_503f_57c2_86c7_bb40030481f0'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ArsenicAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_41dba862_503f_57c2_86c7_bb40030481f0',
    
    class_name='ArsenicAtom',
