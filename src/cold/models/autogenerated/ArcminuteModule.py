...
class Arcminute(SIAcceptedUnit, NonPrefixedUnit, LengthFractionUnit):
    """
    Class representing the `Arcminute` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Arcminute'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'Arcminute'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#Arcminute',
    
    class_name='Arcminute',
