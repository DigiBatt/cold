...
class BoronAtom(Declared, Atom):
    """
    Class representing the `BoronAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_62cb8f50_5ce5_5f99_9cc8_514eff05d05e'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'BoronAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_62cb8f50_5ce5_5f99_9cc8_514eff05d05e',
    
    class_name='BoronAtom',
