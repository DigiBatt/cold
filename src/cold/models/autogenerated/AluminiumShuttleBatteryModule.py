...
class AluminiumShuttleBattery(AluminiumBattery, SecondaryBattery):
    """
    Class representing the `AluminiumShuttleBattery` entity, which inherits from:
    - AluminiumBattery, SecondaryBattery

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_7db1c7e9_5039_41f2_a5ef_b9e27d080050'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'AluminiumShuttleBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = AluminiumShuttleBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_7db1c7e9_5039_41f2_a5ef_b9e27d080050',
    
    class_name='AluminiumShuttleBattery',
