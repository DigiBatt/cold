...
class LithiumIonBattery(NonAqueousCell, LithiumBattery, RockingChairBattery):
    """
    Class representing the `LithiumIonBattery` entity, which inherits from:
    - NonAqueousCell, LithiumBattery, RockingChairBattery

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_96addc62_ea04_449a_8237_4cd541dd8e5f'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LithiumIonBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = LithiumIonBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_96addc62_ea04_449a_8237_4cd541dd8e5f',
    
    class_name='LithiumIonBattery',
