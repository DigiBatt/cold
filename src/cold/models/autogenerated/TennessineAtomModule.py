...
class TennessineAtom(Declared, Atom):
    """
    Class representing the `TennessineAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_706cac26_78f1_5ca4_a63c_2600828db412'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'TennessineAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_706cac26_78f1_5ca4_a63c_2600828db412',
    
    class_name='TennessineAtom',
