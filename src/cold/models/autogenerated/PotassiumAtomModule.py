...
class PotassiumAtom(Declared, Atom):
    """
    Class representing the `PotassiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_d7c9e90e_ba46_55b2_9671_43408f6a1d74'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PotassiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_d7c9e90e_ba46_55b2_9671_43408f6a1d74',
    
    class_name='PotassiumAtom',
