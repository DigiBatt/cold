...
class MegaPascal(PressureUnit, MegaPrefixedUnit, SINonCoherentUnit, PrefixedUnit):
    """
    Class representing the `MegaPascal` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MegaPascal'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MegaPascal'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#MegaPascal',
    
    class_name='MegaPascal',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MegaPascal',
