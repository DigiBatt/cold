...
class CaesiumAtom(Declared, Atom):
    """
    Class representing the `CaesiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_85ab88f1_3bb6_5fb7_8996_d1be786da995'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CaesiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_85ab88f1_3bb6_5fb7_8996_d1be786da995',
    
    class_name='CaesiumAtom',
