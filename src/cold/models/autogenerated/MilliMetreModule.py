...
class MilliMetre(SINonCoherentUnit, MilliPrefixedUnit, LengthUnit, PrefixedUnit):
    """
    Class representing the `MilliMetre` entity, which inherits from:
    - SINonCoherentUnit, MilliPrefixedUnit, LengthUnit, PrefixedUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MilliMetre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MilliMetre'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#MilliMetre',
    
    class_name='MilliMetre',
