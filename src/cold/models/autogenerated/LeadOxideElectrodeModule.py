...
class LeadOxideElectrode(MetalOxideElectrode):
    """
    Class representing the `LeadOxideElectrode` entity, which inherits from:
    - MetalOxideElectrode
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_f6223121_7df5_42f8_902c_d26fa2fc4f04'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LeadOxideElectrode'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = LeadOxideElectrode(
    
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_f6223121_7df5_42f8_902c_d26fa2fc4f04',
    
    class_name='LeadOxideElectrode',
