...
class RockingChairBattery(SecondaryBattery):
    """
    Class representing the `RockingChairBattery` entity, which inherits from:
    - SecondaryBattery
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_ffe472c5_8e0d_49d6_b2be_9453145b4507'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RockingChairBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = RockingChairBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_ffe472c5_8e0d_49d6_b2be_9453145b4507',
    
    class_name='RockingChairBattery',
