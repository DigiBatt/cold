...
class Tesla(SISpecialUnit, MagneticFluxDensityUnit):
    """
    Class representing the `Tesla` entity, which inherits from:
    - SISpecialUnit, MagneticFluxDensityUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Tesla'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Tesla',
