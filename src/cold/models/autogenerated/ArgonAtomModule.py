...
class ArgonAtom(Declared, Atom):
    """
    Class representing the `ArgonAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_755d962f_c703_514f_8d90_ca4f55e331d4'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ArgonAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_755d962f_c703_514f_8d90_ca4f55e331d4',
    
    class_name='ArgonAtom',
