...
class IronAtom(Declared, Atom):
    """
    Class representing the `IronAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_a4839f08_1080_53bf_9cb3_101e20c2656b'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'IronAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_a4839f08_1080_53bf_9cb3_101e20c2656b',
