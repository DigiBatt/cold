...
from .SodiumIonBatteryModule import SodiumIonBattery
...
class SodiumIonHardCarbonBattery(SodiumIonBattery):
    """
    Class representing the `SodiumIonHardCarbonBattery` entity, which inherits from:
    - SodiumIonBattery
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_d3855d31_6aad_4b6d_ab35_c61669df583e'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SodiumIonHardCarbonBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = SodiumIonHardCarbonBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_d3855d31_6aad_4b6d_ab35_c61669df583e',
    
    class_name='SodiumIonHardCarbonBattery',
