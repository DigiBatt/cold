...
class XenonAtom(Declared, Atom):
    """
    Class representing the `XenonAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_57742ca9_95d8_50f8_9b33_0ded30da4532'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'XenonAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_57742ca9_95d8_50f8_9b33_0ded30da4532',
    
    class_name='XenonAtom',
