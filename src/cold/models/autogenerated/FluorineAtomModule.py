...
class FluorineAtom(Declared, Atom):
    """
    Class representing the `FluorineAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_ff4e0ff1_a3ea_5c59_82dc_75f0abad66eb'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'FluorineAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_ff4e0ff1_a3ea_5c59_82dc_75f0abad66eb',
    
    class_name='FluorineAtom',
