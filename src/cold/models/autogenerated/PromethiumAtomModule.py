...
class PromethiumAtom(Declared, Atom):
    """
    Class representing the `PromethiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_73e73382_f3c0_5d09_bcee_f6e380269388'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PromethiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_73e73382_f3c0_5d09_bcee_f6e380269388',
    
    class_name='PromethiumAtom',
