...
class BatteryPack(Battery):
    """
    Class representing the `BatteryPack` entity, which inherits from:
    - Battery
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_be3b35a7_75a3_4be0_9265_beb178ea7b00'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'BatteryPack'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo/domain/battery#battery_be3b35a7_75a3_4be0_9265_beb178ea7b00',
