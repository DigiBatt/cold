...
class Newton(ForceUnit, SISpecialUnit):
    """
    Class representing the `Newton` entity, which inherits from:
    - ForceUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Newton'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Newton',
