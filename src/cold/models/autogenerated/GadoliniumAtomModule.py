...
class GadoliniumAtom(Declared, Atom):
    """
    Class representing the `GadoliniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_0724601e_642c_5770_bc86_7078e7441664'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'GadoliniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_0724601e_642c_5770_bc86_7078e7441664',
    
    class_name='GadoliniumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_0724601e_642c_5770_bc86_7078e7441664',
        alias="class_iri"
    )
