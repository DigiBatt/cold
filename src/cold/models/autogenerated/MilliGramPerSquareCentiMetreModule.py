...
class MilliGramPerSquareCentiMetre(SINonCoherentUnit, AreaDensityUnit, MilliPrefixedUnit, PrefixedUnit):
    """
    Class representing the `MilliGramPerSquareCentiMetre` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MilliGramPerSquareCentiMetre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MilliGramPerSquareCentiMetre'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = MilliGramPerSquareCentiMetre(
    
    class_iri='https://w3id.org/emmo#MilliGramPerSquareCentiMetre',
    
    class_name='MilliGramPerSquareCentiMetre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MilliGramPerSquareCentiMetre',
