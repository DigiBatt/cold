...
class SIMetricSubMultipleUnit(SIMetricPrefixedUnit):
    """
    Class representing the `SIMetricSubMultipleUnit` entity, which inherits from:
    ...
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SIMetricSubMultipleUnit'`
        - **Alias**: `class_name`
