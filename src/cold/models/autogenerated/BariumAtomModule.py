...
class BariumAtom(Declared, Atom):
    """
    Class representing the `BariumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_1b1aa658_a7d5_5bc6_9d78_37a901fd66dd'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'BariumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_1b1aa658_a7d5_5bc6_9d78_37a901fd66dd',
    
    class_name='BariumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_1b1aa658_a7d5_5bc6_9d78_37a901fd66dd',
        alias="class_iri"
    )
