...
class KiloVoltAmpereReactiveHour(NonSIUnit, KiloPrefixedUnit, PrefixedUnit, EnergyUnit):
    """
    Class representing the `KiloVoltAmpereReactiveHour` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#KiloVoltAmpereReactiveHour'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KiloVoltAmpereReactiveHour'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = KiloVoltAmpereReactiveHour(
    
    class_iri='https://w3id.org/emmo#KiloVoltAmpereReactiveHour',
    
    class_name='KiloVoltAmpereReactiveHour',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#KiloVoltAmpereReactiveHour',
