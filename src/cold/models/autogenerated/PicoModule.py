...
class Pico(SISubMultiplePrefix):
    """
    Class representing the `Pico` entity, which inherits from:
    - SISubMultiplePrefix
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_2b243e59_3a2a_412e_9a58_81d1e5c92fbe'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#EMMO_2b243e59_3a2a_412e_9a58_81d1e5c92fbe',
