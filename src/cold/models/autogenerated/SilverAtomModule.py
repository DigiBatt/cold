...
class SilverAtom(Declared, Atom):
    """
    Class representing the `SilverAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_36ab7281_0187_568f_b0b4_61e33dc08cfc'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SilverAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_36ab7281_0187_568f_b0b4_61e33dc08cfc',
    
    class_name='SilverAtom',
