...
class MagnesiumAtom(Declared, Atom):
    """
    Class representing the `MagnesiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_ff5e8306_8e33_5305_84aa_d99055d34e0c'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MagnesiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_ff5e8306_8e33_5305_84aa_d99055d34e0c',
    
    class_name='MagnesiumAtom',
