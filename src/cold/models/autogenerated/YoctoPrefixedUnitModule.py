...
class YoctoPrefixedUnit(SIMetricSubMultipleUnit):
    """
    Class representing the `YoctoPrefixedUnit` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_f5769206_9257_4b08_bf7b_dad7868c6afc'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'YoctoPrefixedUnit'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = YoctoPrefixedUnit(
    
    class_iri='https://w3id.org/emmo#EMMO_f5769206_9257_4b08_bf7b_dad7868c6afc',
    
    class_name='YoctoPrefixedUnit',
