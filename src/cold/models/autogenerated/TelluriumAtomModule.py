...
class TelluriumAtom(Declared, Atom):
    """
    Class representing the `TelluriumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_c1b40f92_d27d_5aa0_9811_b6c58391f951'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'TelluriumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_c1b40f92_d27d_5aa0_9811_b6c58391f951',
    
    class_name='TelluriumAtom',
