...
from .RotatingDiskElectrodeModule import RotatingDiskElectrode
...
class RotatingRingDiskElectrode(RotatingDiskElectrode):
    """
    Class representing the `RotatingRingDiskElectrode` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_7f4d74cd_d0a5_4908_9da9_7629fe419917'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RotatingRingDiskElectrode'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = RotatingRingDiskElectrode(
    
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_7f4d74cd_d0a5_4908_9da9_7629fe419917',
    
    class_name='RotatingRingDiskElectrode',
