...
class KiloMetrePerHour(SpeedUnit, KiloPrefixedUnit, SINonCoherentUnit, PrefixedUnit):
    """
    Class representing the `KiloMetrePerHour` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#KiloMetrePerHour'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KiloMetrePerHour'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = KiloMetrePerHour(
    
    class_iri='https://w3id.org/emmo#KiloMetrePerHour',
    
    class_name='KiloMetrePerHour',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#KiloMetrePerHour',
