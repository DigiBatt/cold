...
class CubicMetre(SICoherentDerivedUnit, VolumeUnit):
    """
    Class representing the `CubicMetre` entity, which inherits from:
    - SICoherentDerivedUnit, VolumeUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#CubicMetre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CubicMetre'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#CubicMetre',
    
    class_name='CubicMetre',
