...
class MilliJoule(SINonCoherentUnit, MilliPrefixedUnit, PrefixedUnit, EnergyUnit):
    """
    Class representing the `MilliJoule` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MilliJoule'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MilliJoule'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#MilliJoule',
    
    class_name='MilliJoule',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MilliJoule',
