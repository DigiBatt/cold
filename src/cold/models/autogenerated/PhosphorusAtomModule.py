...
class PhosphorusAtom(Declared, Atom):
    """
    Class representing the `PhosphorusAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_7905373a_cf03_57fe_a627_bfdb1db9369c'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PhosphorusAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_7905373a_cf03_57fe_a627_bfdb1db9369c',
    
    class_name='PhosphorusAtom',
