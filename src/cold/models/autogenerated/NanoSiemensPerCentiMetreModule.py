...
class NanoSiemensPerCentiMetre(SINonCoherentUnit, ElectricConductivityUnit, PrefixedUnit, NanoPrefixedUnit):
    """
    Class representing the `NanoSiemensPerCentiMetre` entity, which inherits from:
    - SINonCoherentUnit, ElectricConductivityUnit, PrefixedUnit, NanoPrefixedUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#NanoSiemensPerCentiMetre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NanoSiemensPerCentiMetre'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = NanoSiemensPerCentiMetre(
    
    class_iri='https://w3id.org/emmo#NanoSiemensPerCentiMetre',
    
    class_name='NanoSiemensPerCentiMetre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#NanoSiemensPerCentiMetre',
