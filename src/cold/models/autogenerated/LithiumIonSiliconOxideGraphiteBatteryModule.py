...
class LithiumIonSiliconOxideGraphiteBattery(LithiumIonBattery):
    """
    Class representing the `LithiumIonSiliconOxideGraphiteBattery` entity, which inherits from:
    - LithiumIonBattery
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_b3405eb1_801e_416b_8cd2_1473f1868e27'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LithiumIonSiliconOxideGraphiteBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = LithiumIonSiliconOxideGraphiteBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_b3405eb1_801e_416b_8cd2_1473f1868e27',
    
    class_name='LithiumIonSiliconOxideGraphiteBattery',
