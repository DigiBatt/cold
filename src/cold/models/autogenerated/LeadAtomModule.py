...
class LeadAtom(Declared, Atom):
    """
    Class representing the `LeadAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_749a9347_0b50_530a_995a_054f2a90bc0d'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LeadAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_749a9347_0b50_530a_995a_054f2a90bc0d',
