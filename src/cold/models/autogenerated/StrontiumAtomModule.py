...
class StrontiumAtom(Declared, Atom):
    """
    Class representing the `StrontiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_8ec7fdf6_5652_547d_942f_b8b09ad84660'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'StrontiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_8ec7fdf6_5652_547d_942f_b8b09ad84660',
    
    class_name='StrontiumAtom',
