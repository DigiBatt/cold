...
class AntimonyAtom(Declared, Atom):
    """
    Class representing the `AntimonyAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_c32f8642_f1a1_5fae_8b4e_990b40f6eff8'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'AntimonyAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_c32f8642_f1a1_5fae_8b4e_990b40f6eff8',
    
    class_name='AntimonyAtom',
