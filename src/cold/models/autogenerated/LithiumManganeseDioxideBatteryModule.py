...
class LithiumManganeseDioxideBattery(NonAqueousCell, LithiumMetalBattery):
    """
    Class representing the `LithiumManganeseDioxideBattery` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_05adf5d2_0fbd_4c58_906e_4b875a7f2363'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LithiumManganeseDioxideBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = LithiumManganeseDioxideBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_05adf5d2_0fbd_4c58_906e_4b875a7f2363',
    
    class_name='LithiumManganeseDioxideBattery',
