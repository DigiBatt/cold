...
class CR2025(LithiumManganeseDioxideBattery, CoinCell):
    """
    Class representing the `CR2025` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_9984642f_c9dc_4b98_94f6_6ffe20cfc014'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CR2025'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo/domain/battery#battery_9984642f_c9dc_4b98_94f6_6ffe20cfc014',
