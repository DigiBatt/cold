...
class ChemicalFormula(ChemicalSpecies, SpatioTemporalTessellation, Chemical):
    """
    Class representing the `ChemicalFormula` entity, which inherits from:
    - ChemicalSpecies, SpatioTemporalTessellation, Chemical

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_9236d0aa_cb39_43a1_bbdd_6a2a714951c8'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ChemicalFormula'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_9236d0aa_cb39_43a1_bbdd_6a2a714951c8',
    
    class_name='ChemicalFormula',
