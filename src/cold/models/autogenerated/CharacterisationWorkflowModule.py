...
class CharacterisationWorkflow(Workflow, CharacterisationProcedure):
    """
    Class representing the `CharacterisationWorkflow` entity, which inherits from:
    - Workflow, CharacterisationProcedure

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/characterisation-methodology/chameo#CharacterisationWorkflow'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CharacterisationWorkflow'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = CharacterisationWorkflow(
    
    class_iri='https://w3id.org/emmo/domain/characterisation-methodology/chameo#CharacterisationWorkflow',
    
    class_name='CharacterisationWorkflow',
