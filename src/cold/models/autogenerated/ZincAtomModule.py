...
class ZincAtom(Declared, Atom):
    """
    Class representing the `ZincAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_f4fee945_1d4a_5158_b0ca_eaef9ad40502'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ZincAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_f4fee945_1d4a_5158_b0ca_eaef9ad40502',
