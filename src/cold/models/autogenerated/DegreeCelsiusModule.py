...
class DegreeCelsius(TemperatureUnit, SISpecialUnit):
    """
    Class representing the `DegreeCelsius` entity, which inherits from:
    - TemperatureUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#DegreeCelsius'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'DegreeCelsius'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#DegreeCelsius',
    
    class_name='DegreeCelsius',
