...
class Coulomb(ElectricChargeUnit, SISpecialUnit):
    """
    Class representing the `Coulomb` entity, which inherits from:
    - ElectricChargeUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Coulomb'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Coulomb',
