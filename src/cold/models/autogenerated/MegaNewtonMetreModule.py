...
class MegaNewtonMetre(MegaPrefixedUnit, SINonCoherentUnit, PrefixedUnit, EnergyUnit):
    """
    Class representing the `MegaNewtonMetre` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MegaNewtonMetre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MegaNewtonMetre'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#MegaNewtonMetre',
    
    class_name='MegaNewtonMetre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MegaNewtonMetre',
