...
class MicroHenryPerKiloOhm(TimeUnit, SINonCoherentUnit, MicroPrefixedUnit, PrefixedUnit):
    """
    Class representing the `MicroHenryPerKiloOhm` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MicroHenryPerKiloOhm'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MicroHenryPerKiloOhm'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = MicroHenryPerKiloOhm(
    
    class_iri='https://w3id.org/emmo#MicroHenryPerKiloOhm',
    
    class_name='MicroHenryPerKiloOhm',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MicroHenryPerKiloOhm',
