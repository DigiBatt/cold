...
class MilliGray(SINonCoherentUnit, AbsorbedDoseUnit, MilliPrefixedUnit, PrefixedUnit):
    """
    Class representing the `MilliGray` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MilliGray'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MilliGray'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#MilliGray',
    
    class_name='MilliGray',
