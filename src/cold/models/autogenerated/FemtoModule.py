...
class Femto(SISubMultiplePrefix):
    """
    Class representing the `Femto` entity, which inherits from:
    - SISubMultiplePrefix
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_7fd8ec39_1c4b_4ff3_9bc8_0bf3c27e2db0'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#EMMO_7fd8ec39_1c4b_4ff3_9bc8_0bf3c27e2db0',
