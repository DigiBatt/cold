...
class AluminiumAtom(Declared, Atom):
    """
    Class representing the `AluminiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_7e8f9419_0bda_5aa3_ba88_00b2be6ca69e'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'AluminiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_7e8f9419_0bda_5aa3_ba88_00b2be6ca69e',
    
    class_name='AluminiumAtom',
