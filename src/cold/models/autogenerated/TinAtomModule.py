...
class TinAtom(Declared, Atom):
    """
    Class representing the `TinAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_9aa9e086_ae07_51f6_bf84_788ffdefcb6f'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'TinAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_9aa9e086_ae07_51f6_bf84_788ffdefcb6f',
