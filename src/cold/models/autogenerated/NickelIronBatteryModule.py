...
from .NickelOxideBatteryModule import NickelOxideBattery
...
class NickelIronBattery(AlkalineCell, NickelOxideBattery, SecondaryBattery, IronBattery):
    """
    Class representing the `NickelIronBattery` entity, which inherits from:
    - AlkalineCell, NickelOxideBattery, SecondaryBattery, IronBattery

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_a316de25_e469_4a60_81fa_fcb0f372502f'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NickelIronBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = NickelIronBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_a316de25_e469_4a60_81fa_fcb0f372502f',
    
    class_name='NickelIronBattery',
