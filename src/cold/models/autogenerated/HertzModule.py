...
class Hertz(FrequencyUnit, SISpecialUnit):
    """
    Class representing the `Hertz` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Hertz'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Hertz',
