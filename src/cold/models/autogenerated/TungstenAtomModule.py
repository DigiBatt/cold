...
class TungstenAtom(Declared, Atom):
    """
    Class representing the `TungstenAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_7b7d258b_3ea7_5716_af58_afc68679de23'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'TungstenAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_7b7d258b_3ea7_5716_af58_afc68679de23',
    
    class_name='TungstenAtom',
