...
class LithiumNickelOxideElectrode(NickelBasedElectrode, MetalOxideElectrode):
    """
    Class representing the `LithiumNickelOxideElectrode` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_cab66388_3feb_4101_82bc_f4441f0b60e3'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LithiumNickelOxideElectrode'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = LithiumNickelOxideElectrode(
    
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_cab66388_3feb_4101_82bc_f4441f0b60e3',
    
    class_name='LithiumNickelOxideElectrode',
