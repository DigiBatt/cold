...
class MilliSievert(SINonCoherentUnit, AbsorbedDoseUnit, MilliPrefixedUnit, PrefixedUnit):
    """
    Class representing the `MilliSievert` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MilliSievert'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MilliSievert'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#MilliSievert',
    
    class_name='MilliSievert',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MilliSievert',
