...
class Hectare(AreaUnit, SpecialUnit):
    """
    Class representing the `Hectare` entity, which inherits from:
    - AreaUnit, SpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Hectare'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'Hectare'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#Hectare',
