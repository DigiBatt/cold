...
class PetaPrefixedUnit(SIMetricMultipleUnit):
    """
    Class representing the `PetaPrefixedUnit` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_43a6b269_da31_4bb6_a537_c97df4fff32a'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PetaPrefixedUnit'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = PetaPrefixedUnit(
    
    class_iri='https://w3id.org/emmo#EMMO_43a6b269_da31_4bb6_a537_c97df4fff32a',
    
    class_name='PetaPrefixedUnit',
