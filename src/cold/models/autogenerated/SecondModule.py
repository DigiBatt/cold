...
class Second(TimeUnit, SIBaseUnit):
    """
    Class representing the `Second` entity, which inherits from:
    - TimeUnit, SIBaseUnit
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Second'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Second',
