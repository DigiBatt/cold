...
class Lumen(LuminousIntensityUnit, SISpecialUnit):
    """
    Class representing the `Lumen` entity, which inherits from:
    - LuminousIntensityUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Lumen'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Lumen',
