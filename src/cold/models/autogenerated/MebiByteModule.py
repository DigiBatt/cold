...
class MebiByte(CountingUnit, SINonCoherentUnit, PrefixedUnit):
    """
    Class representing the `MebiByte` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MebiByte'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MebiByte'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#MebiByte',
