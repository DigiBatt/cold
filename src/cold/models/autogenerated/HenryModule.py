...
class Henry(InductanceUnit, SISpecialUnit):
    """
    Class representing the `Henry` entity, which inherits from:
    - InductanceUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Henry'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Henry',
