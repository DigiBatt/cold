...
class CuriumAtom(Declared, Atom):
    """
    Class representing the `CuriumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_08522112_0872_599f_9d81_81889333254e'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CuriumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_08522112_0872_599f_9d81_81889333254e',
    
    class_name='CuriumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_08522112_0872_599f_9d81_81889333254e',
        alias="class_iri"
    )
