...
class HolmiumAtom(Declared, Atom):
    """
    Class representing the `HolmiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_fd03c660_7b3b_5451_9d78_bc48836e1cc6'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'HolmiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_fd03c660_7b3b_5451_9d78_bc48836e1cc6',
    
    class_name='HolmiumAtom',
