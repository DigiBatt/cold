...
class ProtactiniumAtom(Declared, Atom):
    """
    Class representing the `ProtactiniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_29987c5a_a7fb_5207_9610_b94316977a3d'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ProtactiniumAtom'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = ProtactiniumAtom(
    
    class_iri='https://w3id.org/emmo#EMMO_29987c5a_a7fb_5207_9610_b94316977a3d',
    
    class_name='ProtactiniumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_29987c5a_a7fb_5207_9610_b94316977a3d',
        alias="class_iri"
    )
