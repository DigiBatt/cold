...
class Watt(PowerUnit, SISpecialUnit):
    """
    Class representing the `Watt` entity, which inherits from:
    - PowerUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Watt'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Watt',
