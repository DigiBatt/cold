...
class ScandiumAtom(Declared, Atom):
    """
    Class representing the `ScandiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_fbfd4b93_12ee_5a15_8377_d4c54635b5de'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ScandiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_fbfd4b93_12ee_5a15_8377_d4c54635b5de',
    
    class_name='ScandiumAtom',
