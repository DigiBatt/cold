...
class MegaByte(CountingUnit, MegaPrefixedUnit, SINonCoherentUnit, PrefixedUnit):
    """
    Class representing the `MegaByte` entity, which inherits from:
    - CountingUnit, MegaPrefixedUnit, SINonCoherentUnit, PrefixedUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MegaByte'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#MegaByte',
