...
class CoperniciumAtom(Declared, Atom):
    """
    Class representing the `CoperniciumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_f9125b67_8798_5595_9db3_ffc1840c9947'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CoperniciumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_f9125b67_8798_5595_9db3_ffc1840c9947',
    
    class_name='CoperniciumAtom',
