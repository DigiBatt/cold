...
class KiloBecquerel(FrequencyUnit, KiloPrefixedUnit, SINonCoherentUnit, PrefixedUnit):
    """
    Class representing the `KiloBecquerel` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#KiloBecquerel'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KiloBecquerel'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#KiloBecquerel',
    
    class_name='KiloBecquerel',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#KiloBecquerel',
