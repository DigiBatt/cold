...
class PicoMolePerLitre(PicoPrefixedUnit, SINonCoherentUnit, PrefixedUnit, AmountConcentrationUnit):
    """
    Class representing the `PicoMolePerLitre` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#PicoMolePerLitre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PicoMolePerLitre'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = PicoMolePerLitre(
    
    class_iri='https://w3id.org/emmo#PicoMolePerLitre',
    
    class_name='PicoMolePerLitre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#PicoMolePerLitre',
