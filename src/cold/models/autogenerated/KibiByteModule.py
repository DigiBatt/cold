...
class KibiByte(CountingUnit, SINonCoherentUnit, PrefixedUnit):
    """
    Class representing the `KibiByte` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#KibiByte'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KibiByte'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#KibiByte',
