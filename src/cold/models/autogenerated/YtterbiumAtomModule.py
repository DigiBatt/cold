...
class YtterbiumAtom(Declared, Atom):
    """
    Class representing the `YtterbiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_8d722efa_b49d_51b1_8bf3_bf50ba4b438c'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'YtterbiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_8d722efa_b49d_51b1_8bf3_bf50ba4b438c',
    
    class_name='YtterbiumAtom',
