...
class TitaniumAtom(Declared, Atom):
    """
    Class representing the `TitaniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_0eee5986_12a1_5f73_b5e0_6eb2b640c924'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'TitaniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_0eee5986_12a1_5f73_b5e0_6eb2b640c924',
    
    class_name='TitaniumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_0eee5986_12a1_5f73_b5e0_6eb2b640c924',
        alias="class_iri"
    )
