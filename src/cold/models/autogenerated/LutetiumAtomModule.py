...
class LutetiumAtom(Declared, Atom):
    """
    Class representing the `LutetiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_098f6f77_746a_5fcc_a6d1_4988929bf404'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LutetiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_098f6f77_746a_5fcc_a6d1_4988929bf404',
    
    class_name='LutetiumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_098f6f77_746a_5fcc_a6d1_4988929bf404',
        alias="class_iri"
    )
