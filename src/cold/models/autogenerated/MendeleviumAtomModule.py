...
class MendeleviumAtom(Declared, Atom):
    """
    Class representing the `MendeleviumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_e85b68e1_ca2b_51b5_8b61_dea134d88bef'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MendeleviumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_e85b68e1_ca2b_51b5_8b61_dea134d88bef',
    
    class_name='MendeleviumAtom',
