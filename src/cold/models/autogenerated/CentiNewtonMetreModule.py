...
class CentiNewtonMetre(SINonCoherentUnit, CentiPrefixedUnit, PrefixedUnit, EnergyUnit):
    """
    Class representing the `CentiNewtonMetre` entity, which inherits from:
    - SINonCoherentUnit, CentiPrefixedUnit, PrefixedUnit, EnergyUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#CentiNewtonMetre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CentiNewtonMetre'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = CentiNewtonMetre(
    
    class_iri='https://w3id.org/emmo#CentiNewtonMetre',
    
    class_name='CentiNewtonMetre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#CentiNewtonMetre',
