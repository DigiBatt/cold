...
class RheniumAtom(Declared, Atom):
    """
    Class representing the `RheniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_8d93f51b_c7c7_5486_b64a_ee206f6b6672'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RheniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_8d93f51b_c7c7_5486_b64a_ee206f6b6672',
    
    class_name='RheniumAtom',
