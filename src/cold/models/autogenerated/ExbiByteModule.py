...
class ExbiByte(CountingUnit, PrefixedUnit):
    """
    Class representing the `ExbiByte` entity, which inherits from:
    - CountingUnit, PrefixedUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#ExbiByte'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ExbiByte'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#ExbiByte',
