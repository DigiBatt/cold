...
class RadonAtom(Declared, Atom):
    """
    Class representing the `RadonAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_fd99c17e_6385_5b97_a20c_eddffdd56837'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RadonAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_fd99c17e_6385_5b97_a20c_eddffdd56837',
    
    class_name='RadonAtom',
