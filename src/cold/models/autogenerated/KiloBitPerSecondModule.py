...
class KiloBitPerSecond(FrequencyUnit, KiloPrefixedUnit, SINonCoherentUnit, PrefixedUnit):
    """
    Class representing the `KiloBitPerSecond` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#KiloBitPerSecond'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KiloBitPerSecond'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = KiloBitPerSecond(
    
    class_iri='https://w3id.org/emmo#KiloBitPerSecond',
    
    class_name='KiloBitPerSecond',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#KiloBitPerSecond',
