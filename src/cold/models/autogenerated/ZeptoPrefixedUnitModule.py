...
class ZeptoPrefixedUnit(SIMetricSubMultipleUnit):
    """
    Class representing the `ZeptoPrefixedUnit` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_254472c6_3dbd_4f02_bc43_571389cd281f'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ZeptoPrefixedUnit'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = ZeptoPrefixedUnit(
    
    class_iri='https://w3id.org/emmo#EMMO_254472c6_3dbd_4f02_bc43_571389cd281f',
    
    class_name='ZeptoPrefixedUnit',
