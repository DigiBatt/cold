...
class HydrogenAtom(Declared, Atom):
    """
    Class representing the `HydrogenAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_5a4790e5_b11b_5a0c_80e4_81515c27a560'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'HydrogenAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_5a4790e5_b11b_5a0c_80e4_81515c27a560',
    
    class_name='HydrogenAtom',
