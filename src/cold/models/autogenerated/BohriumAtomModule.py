...
class BohriumAtom(Declared, Atom):
    """
    Class representing the `BohriumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_67761ddc_260b_5945_bfc3_311813ab71c9'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'BohriumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_67761ddc_260b_5945_bfc3_311813ab71c9',
    
    class_name='BohriumAtom',
