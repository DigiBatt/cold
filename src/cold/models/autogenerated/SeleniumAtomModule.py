...
class SeleniumAtom(Declared, Atom):
    """
    Class representing the `SeleniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_808f7cd9_27b4_527b_974f_4213f10e1772'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SeleniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_808f7cd9_27b4_527b_974f_4213f10e1772',
    
    class_name='SeleniumAtom',
