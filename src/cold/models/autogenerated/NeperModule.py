...
class Neper(SpecialUnit, LogarithmicUnit):
    """
    Class representing the `Neper` entity, which inherits from:
    - SpecialUnit, LogarithmicUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Neper'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Neper',
