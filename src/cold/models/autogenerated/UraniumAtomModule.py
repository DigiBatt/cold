...
class UraniumAtom(Declared, Atom):
    """
    Class representing the `UraniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_b233f8c0_37d8_51ae_9264_560e6649e246'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'UraniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_b233f8c0_37d8_51ae_9264_560e6649e246',
    
    class_name='UraniumAtom',
