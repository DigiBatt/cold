...
class ZincShuttleBattery(ZincBattery):
    """
    Class representing the `ZincShuttleBattery` entity, which inherits from:
    - ZincBattery
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_b023508b_62eb_4b7d_9b4d_0715be990dd8'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ZincShuttleBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = ZincShuttleBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_b023508b_62eb_4b7d_9b4d_0715be990dd8',
    
    class_name='ZincShuttleBattery',
