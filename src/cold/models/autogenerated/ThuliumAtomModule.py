...
class ThuliumAtom(Declared, Atom):
    """
    Class representing the `ThuliumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_82f9a8f3_2bb4_5d14_9a41_30a858ecce61'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ThuliumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_82f9a8f3_2bb4_5d14_9a41_30a858ecce61',
    
    class_name='ThuliumAtom',
