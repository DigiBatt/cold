...
class ThalliumAtom(Declared, Atom):
    """
    Class representing the `ThalliumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_bcf70555_8df3_5a39_b26a_a5e802d17a37'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ThalliumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_bcf70555_8df3_5a39_b26a_a5e802d17a37',
    
    class_name='ThalliumAtom',
