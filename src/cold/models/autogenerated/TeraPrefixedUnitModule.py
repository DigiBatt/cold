...
class TeraPrefixedUnit(SIMetricMultipleUnit):
    """
    Class representing the `TeraPrefixedUnit` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_3a204900_2b33_47d1_b444_815cc4c8cffa'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'TeraPrefixedUnit'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = TeraPrefixedUnit(
    
    class_iri='https://w3id.org/emmo#EMMO_3a204900_2b33_47d1_b444_815cc4c8cffa',
    
    class_name='TeraPrefixedUnit',
