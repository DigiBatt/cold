...
class MicroGravity(AccelerationUnit, SINonCoherentUnit, MicroPrefixedUnit, PrefixedUnit):
    """
    Class representing the `MicroGravity` entity, which inherits from:
    - AccelerationUnit, SINonCoherentUnit, MicroPrefixedUnit, PrefixedUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MicroGravity'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MicroGravity'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#MicroGravity',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MicroGravity',
