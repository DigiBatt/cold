...
from .CopperBasedElectrodeModule import CopperBasedElectrode
...
class CopperOxideElectrode(CopperBasedElectrode, MetalOxideElectrode):
    """
    Class representing the `CopperOxideElectrode` entity, which inherits from:
    - CopperBasedElectrode, MetalOxideElectrode

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_a8edd38f_f8a5_41fb_9fc7_48f1866fd699'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CopperOxideElectrode'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = CopperOxideElectrode(
    
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_a8edd38f_f8a5_41fb_9fc7_48f1866fd699',
    
    class_name='CopperOxideElectrode',
