...
class IodineAtom(Declared, Atom):
    """
    Class representing the `IodineAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_52a611ba_81df_5557_9dfe_c55e4d0f5860'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'IodineAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_52a611ba_81df_5557_9dfe_c55e4d0f5860',
    
    class_name='IodineAtom',
