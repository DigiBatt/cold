...
class IridiumAtom(Declared, Atom):
    """
    Class representing the `IridiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_5ae62317_1681_5ca9_9fa7_8801757ee5c8'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'IridiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_5ae62317_1681_5ca9_9fa7_8801757ee5c8',
    
    class_name='IridiumAtom',
