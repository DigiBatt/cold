...
class CobaltAtom(Declared, Atom):
    """
    Class representing the `CobaltAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_3fe9d899_f1f1_5657_b176_ac6afff2e93d'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CobaltAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_3fe9d899_f1f1_5657_b176_ac6afff2e93d',
    
    class_name='CobaltAtom',
