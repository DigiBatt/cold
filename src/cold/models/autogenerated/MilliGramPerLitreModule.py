...
class MilliGramPerLitre(DensityUnit, SINonCoherentUnit, MilliPrefixedUnit, PrefixedUnit):
    """
    Class representing the `MilliGramPerLitre` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MilliGramPerLitre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MilliGramPerLitre'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = MilliGramPerLitre(
    
    class_iri='https://w3id.org/emmo#MilliGramPerLitre',
    
    class_name='MilliGramPerLitre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MilliGramPerLitre',
