...
class ThoriumAtom(Declared, Atom):
    """
    Class representing the `ThoriumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_59d342fd_1ace_5b68_9d0d_ed4ff9f55d63'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ThoriumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_59d342fd_1ace_5b68_9d0d_ed4ff9f55d63',
    
    class_name='ThoriumAtom',
