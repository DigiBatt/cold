...
class KiloNewtonMetre(KiloPrefixedUnit, SINonCoherentUnit, PrefixedUnit, EnergyUnit):
    """
    Class representing the `KiloNewtonMetre` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#KiloNewtonMetre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KiloNewtonMetre'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#KiloNewtonMetre',
    
    class_name='KiloNewtonMetre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#KiloNewtonMetre',
