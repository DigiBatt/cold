...
class ErbiumAtom(Declared, Atom):
    """
    Class representing the `ErbiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_14729316_fa36_5eda_a5e6_86e28a5d80ba'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ErbiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_14729316_fa36_5eda_a5e6_86e28a5d80ba',
    
    class_name='ErbiumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_14729316_fa36_5eda_a5e6_86e28a5d80ba',
        alias="class_iri"
    )
