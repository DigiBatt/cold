...
class GoldAtom(Declared, Atom):
    """
    Class representing the `GoldAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_0d37beeb_9dea_558e_82c5_4df3fb6d08d0'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'GoldAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_0d37beeb_9dea_558e_82c5_4df3fb6d08d0',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_0d37beeb_9dea_558e_82c5_4df3fb6d08d0',
        alias="class_iri"
    )
