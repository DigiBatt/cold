...
class SodiumAtom(Declared, Atom):
    """
    Class representing the `SodiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_dea931ca_1ec7_58f8_88e5_fb5615d8b214'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SodiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_dea931ca_1ec7_58f8_88e5_fb5615d8b214',
    
    class_name='SodiumAtom',
