...
class PraseodymiumAtom(Declared, Atom):
    """
    Class representing the `PraseodymiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_18748aef_0e6b_5369_99b5_1e5ab1a0f99b'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PraseodymiumAtom'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = PraseodymiumAtom(
    
    class_iri='https://w3id.org/emmo#EMMO_18748aef_0e6b_5369_99b5_1e5ab1a0f99b',
    
    class_name='PraseodymiumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_18748aef_0e6b_5369_99b5_1e5ab1a0f99b',
        alias="class_iri"
    )
