...
class Lux(LuminanceUnit, SISpecialUnit):
    """
    Class representing the `Lux` entity, which inherits from:
    - LuminanceUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Lux'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Lux',
