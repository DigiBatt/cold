...
class PoloniumAtom(Declared, Atom):
    """
    Class representing the `PoloniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_784119c1_c336_5b0c_80fc_4cc8bddc99ca'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PoloniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_784119c1_c336_5b0c_80fc_4cc8bddc99ca',
    
    class_name='PoloniumAtom',
