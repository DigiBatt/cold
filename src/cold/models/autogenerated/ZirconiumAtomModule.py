...
class ZirconiumAtom(Declared, Atom):
    """
    Class representing the `ZirconiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_c052baf7_358f_55de_8ca3_9688563c3cfb'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ZirconiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_c052baf7_358f_55de_8ca3_9688563c3cfb',
    
    class_name='ZirconiumAtom',
