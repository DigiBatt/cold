...
class KiloMolePerSecond(KiloPrefixedUnit, SINonCoherentUnit, PrefixedUnit, CatalyticActivityUnit):
    """
    Class representing the `KiloMolePerSecond` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#KiloMolePerSecond'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KiloMolePerSecond'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = KiloMolePerSecond(
    
    class_iri='https://w3id.org/emmo#KiloMolePerSecond',
    
    class_name='KiloMolePerSecond',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#KiloMolePerSecond',
