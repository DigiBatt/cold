...
class CalciumAtom(Declared, Atom):
    """
    Class representing the `CalciumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_2b6dcba2_8e5f_50fb_8242_26fa609379a8'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CalciumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_2b6dcba2_8e5f_50fb_8242_26fa609379a8',
    
    class_name='CalciumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_2b6dcba2_8e5f_50fb_8242_26fa609379a8',
        alias="class_iri"
    )
