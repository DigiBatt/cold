...
class NeodymiumAtom(Declared, Atom):
    """
    Class representing the `NeodymiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_2e6eba5e_8c55_534c_b955_f09296e190e0'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NeodymiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_2e6eba5e_8c55_534c_b955_f09296e190e0',
    
    class_name='NeodymiumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_2e6eba5e_8c55_534c_b955_f09296e190e0',
        alias="class_iri"
    )
