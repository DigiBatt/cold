...
class MilliGramPerMilliLitre(DensityUnit, SINonCoherentUnit, MilliPrefixedUnit, PrefixedUnit):
    """
    Class representing the `MilliGramPerMilliLitre` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MilliGramPerMilliLitre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MilliGramPerMilliLitre'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = MilliGramPerMilliLitre(
    
    class_iri='https://w3id.org/emmo#MilliGramPerMilliLitre',
    
    class_name='MilliGramPerMilliLitre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MilliGramPerMilliLitre',
