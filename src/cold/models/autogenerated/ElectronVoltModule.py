...
class ElectronVolt(SpecialUnit, EnergyUnit):
    """
    Class representing the `ElectronVolt` entity, which inherits from:
    - SpecialUnit, EnergyUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#ElectronVolt'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ElectronVolt'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#ElectronVolt',
    
    class_name='ElectronVolt',
