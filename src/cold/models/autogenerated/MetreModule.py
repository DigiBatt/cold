...
class Metre(SIBaseUnit, LengthUnit):
    """
    Class representing the `Metre` entity, which inherits from:
    - SIBaseUnit, LengthUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Metre'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Metre',
