...
class ElectrodePolarisation(Whole, ElectrochemicalPhenomenon):
    """
    Class representing the `ElectrodePolarisation` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_2e6933aa_4522_4f16_a437_37110e6cbd0d'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ElectrodePolarisation'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = ElectrodePolarisation(
    
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_2e6933aa_4522_4f16_a437_37110e6cbd0d',
    
    class_name='ElectrodePolarisation',
