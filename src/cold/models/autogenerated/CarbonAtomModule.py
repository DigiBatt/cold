...
class CarbonAtom(Declared, Atom):
    """
    Class representing the `CarbonAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_0056cc2f_f2fe_558e_a65c_9a8fc5cea333'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CarbonAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_0056cc2f_f2fe_558e_a65c_9a8fc5cea333',
    
    class_name='CarbonAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_0056cc2f_f2fe_558e_a65c_9a8fc5cea333',
        alias="class_iri"
    )
