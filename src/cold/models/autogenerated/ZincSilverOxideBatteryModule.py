...
from .SilverOxideBatteryModule import SilverOxideBattery
...
class ZincSilverOxideBattery(PrimaryBattery, AlkalineCell, SilverOxideBattery, ZincBattery):
    """
    Class representing the `ZincSilverOxideBattery` entity, which inherits from:
    - PrimaryBattery, AlkalineCell, SilverOxideBattery, ZincBattery

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_b81610fd_0bce_411b_986e_f3b4f3f562ab'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ZincSilverOxideBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = ZincSilverOxideBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_b81610fd_0bce_411b_986e_f3b4f3f562ab',
    
    class_name='ZincSilverOxideBattery',
