...
class PotentiostaticCycling(CharacterisationWorkflow, VoltageControlledProcess, Cycling):
    """
    Class representing the `PotentiostaticCycling` entity, which inherits from:
    - CharacterisationWorkflow, VoltageControlledProcess, Cycling

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_5a5ef74b_e4a7_4b85_ab21_ae0febebaf58'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PotentiostaticCycling'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = PotentiostaticCycling(
    
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_5a5ef74b_e4a7_4b85_ab21_ae0febebaf58',
    
    class_name='PotentiostaticCycling',
