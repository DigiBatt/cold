...
class KiloHertz(FrequencyUnit, KiloPrefixedUnit, SINonCoherentUnit, PrefixedUnit):
    """
    Class representing the `KiloHertz` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#KiloHertz'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KiloHertz'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#KiloHertz',
    
    class_name='KiloHertz',
