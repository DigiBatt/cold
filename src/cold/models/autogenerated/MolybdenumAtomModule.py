...
class MolybdenumAtom(Declared, Atom):
    """
    Class representing the `MolybdenumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_0d8247fb_82b0_5ad6_996b_19469e1d7960'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MolybdenumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_0d8247fb_82b0_5ad6_996b_19469e1d7960',
    
    class_name='MolybdenumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_0d8247fb_82b0_5ad6_996b_19469e1d7960',
        alias="class_iri"
    )
