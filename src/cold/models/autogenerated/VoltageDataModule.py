...
class VoltageData(Vector, RawData):
    """
    Class representing the `VoltageData` entity, which inherits from:
    - Vector, RawData
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_4d09ddc4_7e71_4712_afab_b33d8df38983'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'VoltageData'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_4d09ddc4_7e71_4712_afab_b33d8df38983',
    
    class_name='VoltageData',
