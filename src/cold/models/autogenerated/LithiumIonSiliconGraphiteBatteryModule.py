...
class LithiumIonSiliconGraphiteBattery(LithiumIonBattery):
    """
    Class representing the `LithiumIonSiliconGraphiteBattery` entity, which inherits from:
    - LithiumIonBattery
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_4d308636_8dac_4cc9_a0a1_197eefeb203f'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LithiumIonSiliconGraphiteBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = LithiumIonSiliconGraphiteBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_4d308636_8dac_4cc9_a0a1_197eefeb203f',
    
    class_name='LithiumIonSiliconGraphiteBattery',
