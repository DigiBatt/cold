...
class HeliumAtom(Declared, Atom):
    """
    Class representing the `HeliumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_2c85ff7a_835c_5559_b369_193683d631c8'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'HeliumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_2c85ff7a_835c_5559_b369_193683d631c8',
    
    class_name='HeliumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_2c85ff7a_835c_5559_b369_193683d631c8',
        alias="class_iri"
    )
