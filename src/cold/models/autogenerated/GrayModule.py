...
class Gray(AbsorbedDoseUnit, SISpecialUnit):
    """
    Class representing the `Gray` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Gray'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Gray',
