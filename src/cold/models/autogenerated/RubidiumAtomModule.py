...
class RubidiumAtom(Declared, Atom):
    """
    Class representing the `RubidiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_c828cd65_e2de_5ae2_b581_4e5d2498e493'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RubidiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_c828cd65_e2de_5ae2_b581_4e5d2498e493',
    
    class_name='RubidiumAtom',
