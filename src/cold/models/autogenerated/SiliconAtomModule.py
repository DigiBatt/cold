...
class SiliconAtom(Declared, Atom):
    """
    Class representing the `SiliconAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_798b0c96_82ca_5ce8_8d5f_f9f72668cf5d'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SiliconAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_798b0c96_82ca_5ce8_8d5f_f9f72668cf5d',
    
    class_name='SiliconAtom',
