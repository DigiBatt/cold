...
class RhodiumAtom(Declared, Atom):
    """
    Class representing the `RhodiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_3bc0aedf_c43e_5d30_8688_44d19900a68b'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RhodiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_3bc0aedf_c43e_5d30_8688_44d19900a68b',
    
    class_name='RhodiumAtom',
