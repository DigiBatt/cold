...
class TerbiumAtom(Declared, Atom):
    """
    Class representing the `TerbiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_e3cd5791_6fbb_587a_a535_0e937800beaa'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'TerbiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_e3cd5791_6fbb_587a_a535_0e937800beaa',
    
    class_name='TerbiumAtom',
