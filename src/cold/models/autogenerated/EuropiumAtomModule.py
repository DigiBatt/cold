...
class EuropiumAtom(Declared, Atom):
    """
    Class representing the `EuropiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_8aa13073_865b_5035_b128_43a4758a0302'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'EuropiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_8aa13073_865b_5035_b128_43a4758a0302',
    
    class_name='EuropiumAtom',
