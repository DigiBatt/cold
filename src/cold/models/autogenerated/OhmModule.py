...
class Ohm(ElectricResistanceUnit, SISpecialUnit):
    """
    Class representing the `Ohm` entity, which inherits from:
    - ElectricResistanceUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Ohm'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Ohm',
