...
class BerylliumAtom(Declared, Atom):
    """
    Class representing the `BerylliumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_b8294a50_b121_5b9c_bacd_5d4206c3aaaf'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'BerylliumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_b8294a50_b121_5b9c_bacd_5d4206c3aaaf',
    
    class_name='BerylliumAtom',
