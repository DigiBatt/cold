...
class RutheniumAtom(Declared, Atom):
    """
    Class representing the `RutheniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_948b47f0_3c24_50c7_a698_a805f760e667'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RutheniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_948b47f0_3c24_50c7_a698_a805f760e667',
    
    class_name='RutheniumAtom',
