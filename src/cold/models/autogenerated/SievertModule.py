...
class Sievert(AbsorbedDoseUnit, SISpecialUnit):
    """
    Class representing the `Sievert` entity, which inherits from:
    - AbsorbedDoseUnit, SISpecialUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Sievert'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'Sievert'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#Sievert',
