...
class Joule(SISpecialUnit, EnergyUnit):
    """
    Class representing the `Joule` entity, which inherits from:
    - SISpecialUnit, EnergyUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Joule'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Joule',
