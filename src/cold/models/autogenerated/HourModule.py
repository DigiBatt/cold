...
class Hour(TimeUnit, SpecialUnit):
    """
    Class representing the `Hour` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Hour'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Hour',
