...
class DecaPrefixedUnit(SIMetricMultipleUnit):
    """
    Class representing the `DecaPrefixedUnit` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_1d8b370b_c672_4d0c_964e_eaafcbf2f51f'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'DecaPrefixedUnit'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = DecaPrefixedUnit(
    
    class_iri='https://w3id.org/emmo#EMMO_1d8b370b_c672_4d0c_964e_eaafcbf2f51f',
    
    class_name='DecaPrefixedUnit',
