...
class CopperAtom(Declared, Atom):
    """
    Class representing the `CopperAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_57a7ab6b_30a4_54e5_821d_0b8efb5e08b2'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CopperAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_57a7ab6b_30a4_54e5_821d_0b8efb5e08b2',
    
    class_name='CopperAtom',
