...
class LithiumAtom(Declared, Atom):
    """
    Class representing the `LithiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_3bb84fc5_5cb4_5250_ba87_169ae90ec6d7'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LithiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_3bb84fc5_5cb4_5250_ba87_169ae90ec6d7',
    
    class_name='LithiumAtom',
