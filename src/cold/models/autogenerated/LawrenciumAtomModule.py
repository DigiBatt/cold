...
class LawrenciumAtom(Declared, Atom):
    """
    Class representing the `LawrenciumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_41f2ed3b_aba4_5b99_a5a1_547109a7cb4c'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LawrenciumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_41f2ed3b_aba4_5b99_a5a1_547109a7cb4c',
    
    class_name='LawrenciumAtom',
