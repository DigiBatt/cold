...
class Litre(SpecialUnit, VolumeUnit):
    """
    Class representing the `Litre` entity, which inherits from:
    - SpecialUnit, VolumeUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Litre'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Litre',
