...
class VanadiumAtom(Declared, Atom):
    """
    Class representing the `VanadiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_f02b58a5_8f1e_5d72_a261_8fe5ad2fbb4b'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'VanadiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_f02b58a5_8f1e_5d72_a261_8fe5ad2fbb4b',
    
    class_name='VanadiumAtom',
