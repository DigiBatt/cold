...
class NeptuniumAtom(Declared, Atom):
    """
    Class representing the `NeptuniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_15595dc5_20a7_5b9f_a896_aad79f97bb8b'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NeptuniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_15595dc5_20a7_5b9f_a896_aad79f97bb8b',
    
    class_name='NeptuniumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_15595dc5_20a7_5b9f_a896_aad79f97bb8b',
        alias="class_iri"
    )
