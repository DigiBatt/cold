...
class AmericiumAtom(Declared, Atom):
    """
    Class representing the `AmericiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_f90da1f3_eb4c_54c4_b5d9_cf00fef180a1'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'AmericiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_f90da1f3_eb4c_54c4_b5d9_cf00fef180a1',
    
    class_name='AmericiumAtom',
