...
class ChlorineAtom(Declared, Atom):
    """
    Class representing the `ChlorineAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_b92900ac_69b2_5a63_a9d5_4984ae20905a'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ChlorineAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_b92900ac_69b2_5a63_a9d5_4984ae20905a',
    
    class_name='ChlorineAtom',
