...
class NickelAtom(Declared, Atom):
    """
    Class representing the `NickelAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_caacc634_4328_5d9d_a8e8_1c25a2557e94'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NickelAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_caacc634_4328_5d9d_a8e8_1c25a2557e94',
    
    class_name='NickelAtom',
