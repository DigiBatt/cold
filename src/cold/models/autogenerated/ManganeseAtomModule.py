...
class ManganeseAtom(Declared, Atom):
    """
    Class representing the `ManganeseAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_2c701f72_a859_5e33_9552_b6bdbcbd28d9'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ManganeseAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_2c701f72_a859_5e33_9552_b6bdbcbd28d9',
    
    class_name='ManganeseAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_2c701f72_a859_5e33_9552_b6bdbcbd28d9',
        alias="class_iri"
    )
