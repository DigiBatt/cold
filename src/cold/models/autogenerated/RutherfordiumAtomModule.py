...
class RutherfordiumAtom(Declared, Atom):
    """
    Class representing the `RutherfordiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_78c3f353_1296_5dca_9759_7c59a7f53927'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RutherfordiumAtom'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = RutherfordiumAtom(
    
    class_iri='https://w3id.org/emmo#EMMO_78c3f353_1296_5dca_9759_7c59a7f53927',
    
    class_name='RutherfordiumAtom',
