...
class CelsiusTemperatureData(Vector, RawData):
    """
    Class representing the `CelsiusTemperatureData` entity, which inherits from:
    - Vector, RawData
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_efaca8db_a3e0_4188_9c9b_ed0037966725'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CelsiusTemperatureData'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = CelsiusTemperatureData(
    
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_efaca8db_a3e0_4188_9c9b_ed0037966725',
    
    class_name='CelsiusTemperatureData',
