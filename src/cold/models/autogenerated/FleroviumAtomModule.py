...
class FleroviumAtom(Declared, Atom):
    """
    Class representing the `FleroviumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_7aa6b5b1_34c8_5d37_9db0_cc6a232f3946'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'FleroviumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_7aa6b5b1_34c8_5d37_9db0_cc6a232f3946',
    
    class_name='FleroviumAtom',
