...
class MicroMetre(SINonCoherentUnit, MicroPrefixedUnit, LengthUnit, PrefixedUnit):
    """
    Class representing the `MicroMetre` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MicroMetre'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#MicroMetre',
    
    class_name='MicroMetre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MicroMetre',
