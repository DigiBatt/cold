...
class LeclancheBattery(ZincCarbonBattery):
    """
    Class representing the `LeclancheBattery` entity, which inherits from:
    - ZincCarbonBattery
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_1d3a2bb3_1d39_4cdb_9a28_c73d663388ab'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LeclancheBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = LeclancheBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_1d3a2bb3_1d39_4cdb_9a28_c73d663388ab',
    
    class_name='LeclancheBattery',
