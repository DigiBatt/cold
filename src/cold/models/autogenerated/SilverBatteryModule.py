...
class SilverBattery(BatteryCell):
    """
    Class representing the `SilverBattery` entity, which inherits from:
    - BatteryCell
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_664c8bf0_c6b9_4d57_96da_83f36b31ec04'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SilverBattery'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo/domain/battery#battery_664c8bf0_c6b9_4d57_96da_83f36b31ec04',
    
    class_name='SilverBattery',
