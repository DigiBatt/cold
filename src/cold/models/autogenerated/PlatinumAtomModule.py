...
class PlatinumAtom(Declared, Atom):
    """
    Class representing the `PlatinumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_123629bd_efd6_5ba6_979e_2a4698b54e70'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PlatinumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_123629bd_efd6_5ba6_979e_2a4698b54e70',
    
    class_name='PlatinumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_123629bd_efd6_5ba6_979e_2a4698b54e70',
        alias="class_iri"
    )
