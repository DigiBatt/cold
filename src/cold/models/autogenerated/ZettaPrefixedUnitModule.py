...
class ZettaPrefixedUnit(SIMetricMultipleUnit):
    """
    Class representing the `ZettaPrefixedUnit` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_daa9ee97_4c5f_42e5_918c_44d7523e8958'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ZettaPrefixedUnit'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = ZettaPrefixedUnit(
    
    class_iri='https://w3id.org/emmo#EMMO_daa9ee97_4c5f_42e5_918c_44d7523e8958',
    
    class_name='ZettaPrefixedUnit',
