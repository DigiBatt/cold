...
class GermaniumAtom(Declared, Atom):
    """
    Class representing the `GermaniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_694e27a2_f3ee_5a3e_8851_d6f78d79d84e'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'GermaniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_694e27a2_f3ee_5a3e_8851_d6f78d79d84e',
    
    class_name='GermaniumAtom',
