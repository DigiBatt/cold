...
class GigaHertz(FrequencyUnit, SINonCoherentUnit, GigaPrefixedUnit, PrefixedUnit):
    """
    Class representing the `GigaHertz` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#GigaHertz'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'GigaHertz'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#GigaHertz',
    
    class_name='GigaHertz',
