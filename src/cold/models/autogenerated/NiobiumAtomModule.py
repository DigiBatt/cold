...
class NiobiumAtom(Declared, Atom):
    """
    Class representing the `NiobiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_ad2056af_0fa7_56cf_a881_80e3a7dfd266'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NiobiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_ad2056af_0fa7_56cf_a881_80e3a7dfd266',
    
    class_name='NiobiumAtom',
