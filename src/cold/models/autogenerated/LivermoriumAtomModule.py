...
class LivermoriumAtom(Declared, Atom):
    """
    Class representing the `LivermoriumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_f2d4c89a_c354_5e4c_9cdb_f2de932e294f'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'LivermoriumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_f2d4c89a_c354_5e4c_9cdb_f2de932e294f',
    
    class_name='LivermoriumAtom',
