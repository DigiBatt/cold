...
class NitrogenAtom(Declared, Atom):
    """
    Class representing the `NitrogenAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_252f143a_2c00_5d9a_a551_c07daa22c5c0'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NitrogenAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_252f143a_2c00_5d9a_a551_c07daa22c5c0',
    
    class_name='NitrogenAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_252f143a_2c00_5d9a_a551_c07daa22c5c0',
        alias="class_iri"
    )
