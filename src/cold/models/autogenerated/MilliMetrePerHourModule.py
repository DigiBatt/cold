...
class MilliMetrePerHour(SpeedUnit, SINonCoherentUnit, MilliPrefixedUnit, PrefixedUnit):
    """
    Class representing the `MilliMetrePerHour` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MilliMetrePerHour'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MilliMetrePerHour'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = MilliMetrePerHour(
    
    class_iri='https://w3id.org/emmo#MilliMetrePerHour',
    
    class_name='MilliMetrePerHour',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MilliMetrePerHour',
