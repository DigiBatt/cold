...
class OsmiumAtom(Declared, Atom):
    """
    Class representing the `OsmiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_016c831e_66b7_546e_ad4a_fc22c739b0f5'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'OsmiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_016c831e_66b7_546e_ad4a_fc22c739b0f5',
    
    class_name='OsmiumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_016c831e_66b7_546e_ad4a_fc22c739b0f5',
        alias="class_iri"
    )
