...
class SulfurAtom(Declared, Atom):
    """
    Class representing the `SulfurAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_87c8f425_c96c_5503_88a0_f10465669ea3'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SulfurAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_87c8f425_c96c_5503_88a0_f10465669ea3',
    
    class_name='SulfurAtom',
