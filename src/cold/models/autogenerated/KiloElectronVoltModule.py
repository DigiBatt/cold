...
class KiloElectronVolt(PrefixedUnit, EnergyUnit):
    """
    Class representing the `KiloElectronVolt` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#KiloElectronVolt'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KiloElectronVolt'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = KiloElectronVolt(
    
    class_iri='https://w3id.org/emmo#KiloElectronVolt',
    
    class_name='KiloElectronVolt',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#KiloElectronVolt',
