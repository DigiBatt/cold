...
class RoentgeniumAtom(Declared, Atom):
    """
    Class representing the `RoentgeniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_3f29d3e0_e9d9_5f1f_bd77_97af10125f7e'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RoentgeniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_3f29d3e0_e9d9_5f1f_bd77_97af10125f7e',
    
    class_name='RoentgeniumAtom',
