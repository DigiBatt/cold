...
class NanoGramPerMilliLitre(DensityUnit, SINonCoherentUnit, PrefixedUnit, NanoPrefixedUnit):
    """
    Class representing the `NanoGramPerMilliLitre` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#NanoGramPerMilliLitre'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NanoGramPerMilliLitre'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = NanoGramPerMilliLitre(
    
    class_iri='https://w3id.org/emmo#NanoGramPerMilliLitre',
    
    class_name='NanoGramPerMilliLitre',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#NanoGramPerMilliLitre',
