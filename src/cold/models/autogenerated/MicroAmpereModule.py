...
class MicroAmpere(SINonCoherentUnit, MicroPrefixedUnit, PrefixedUnit, ElectricCurrentUnit):
    """
    Class representing the `MicroAmpere` entity, which inherits from:
    - SINonCoherentUnit, MicroPrefixedUnit, PrefixedUnit, ElectricCurrentUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MicroAmpere'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#MicroAmpere',
    
    class_name='MicroAmpere',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MicroAmpere',
