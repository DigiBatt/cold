...
class Zetta(SIMultiplePrefix):
    """
    Class representing the `Zetta` entity, which inherits from:
    - SIMultiplePrefix
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_fbf7da6f_04bb_4c8e_abbf_e4048d6a5e73'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#EMMO_fbf7da6f_04bb_4c8e_abbf_e4048d6a5e73',
