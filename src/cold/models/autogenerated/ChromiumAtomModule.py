...
class ChromiumAtom(Declared, Atom):
    """
    Class representing the `ChromiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_2a61986e_772c_5f68_bdc9_80adbc618e41'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ChromiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_2a61986e_772c_5f68_bdc9_80adbc618e41',
    
    class_name='ChromiumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_2a61986e_772c_5f68_bdc9_80adbc618e41',
        alias="class_iri"
    )
