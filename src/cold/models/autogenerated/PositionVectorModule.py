...
class PositionVector(SpaceAndTimeQuantity):
    """
    Class representing the `PositionVector` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_4312cae4_03ba_457e_b35d_0671a7db350c'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PositionVector'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_4312cae4_03ba_457e_b35d_0671a7db350c',
