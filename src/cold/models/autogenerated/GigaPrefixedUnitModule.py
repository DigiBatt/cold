...
class GigaPrefixedUnit(SIMetricMultipleUnit):
    """
    Class representing the `GigaPrefixedUnit` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_a8eb4bbb_1bd3_4ad4_b114_2789bcbd2134'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'GigaPrefixedUnit'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = GigaPrefixedUnit(
    
    class_iri='https://w3id.org/emmo#EMMO_a8eb4bbb_1bd3_4ad4_b114_2789bcbd2134',
    
    class_name='GigaPrefixedUnit',
