...
class YttriumAtom(Declared, Atom):
    """
    Class representing the `YttriumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_733b8473_aa8f_59d5_81c3_c97ca40ea9d0'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'YttriumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_733b8473_aa8f_59d5_81c3_c97ca40ea9d0',
    
    class_name='YttriumAtom',
