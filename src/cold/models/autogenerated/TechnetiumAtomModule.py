...
class TechnetiumAtom(Declared, Atom):
    """
    Class representing the `TechnetiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_9c803415_5978_5525_9de9_fcf0a2098b4c'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'TechnetiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_9c803415_5978_5525_9de9_fcf0a2098b4c',
    
    class_name='TechnetiumAtom',
