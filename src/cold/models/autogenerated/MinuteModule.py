...
class Minute(TimeUnit, SpecialUnit):
    """
    Class representing the `Minute` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Minute'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Minute',
