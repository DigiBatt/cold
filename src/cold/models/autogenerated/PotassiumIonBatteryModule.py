...
from .PotassiumBatteryModule import PotassiumBattery
...
class PotassiumIonBattery(PotassiumBattery):
    """
    Class representing the `PotassiumIonBattery` entity, which inherits from:
    - PotassiumBattery
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/battery#battery_22cd1325_5cbb_4fb3_b6a6_ae7aab5554a5'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PotassiumIonBattery'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = PotassiumIonBattery(
    
    class_iri='https://w3id.org/emmo/domain/battery#battery_22cd1325_5cbb_4fb3_b6a6_ae7aab5554a5',
    
    class_name='PotassiumIonBattery',
