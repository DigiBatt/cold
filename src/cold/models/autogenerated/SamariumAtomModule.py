...
class SamariumAtom(Declared, Atom):
    """
    Class representing the `SamariumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_65d84215_de2a_56c9_80e3_a49d08dfc1de'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SamariumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_65d84215_de2a_56c9_80e3_a49d08dfc1de',
    
    class_name='SamariumAtom',
