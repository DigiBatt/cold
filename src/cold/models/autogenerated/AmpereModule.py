...
class Ampere(SIBaseUnit, ElectricCurrentUnit):
    """
    Class representing the `Ampere` entity, which inherits from:
    - SIBaseUnit, ElectricCurrentUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Ampere'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Ampere',
