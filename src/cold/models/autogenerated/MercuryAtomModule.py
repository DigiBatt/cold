...
class MercuryAtom(Declared, Atom):
    """
    Class representing the `MercuryAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_bc1bb0e8_ec90_5276_a15c_3e805144a083'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MercuryAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_bc1bb0e8_ec90_5276_a15c_3e805144a083',
    
    class_name='MercuryAtom',
