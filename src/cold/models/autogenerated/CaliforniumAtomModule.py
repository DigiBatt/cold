...
class CaliforniumAtom(Declared, Atom):
    """
    Class representing the `CaliforniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_b443dea3_7407_59c3_9e86_6784e715f48b'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CaliforniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_b443dea3_7407_59c3_9e86_6784e715f48b',
    
    class_name='CaliforniumAtom',
