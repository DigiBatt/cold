...
class OganessonAtom(Declared, Atom):
    """
    Class representing the `OganessonAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_cffec057_9258_52ae_bb4c_ca761b6bc407'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'OganessonAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_cffec057_9258_52ae_bb4c_ca761b6bc407',
    
    class_name='OganessonAtom',
