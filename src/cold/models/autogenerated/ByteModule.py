...
class Byte(CountingUnit, SINonCoherentUnit, NonPrefixedUnit):
    """
    Class representing the `Byte` entity, which inherits from:
    - CountingUnit, SINonCoherentUnit, NonPrefixedUnit

    This class defines the following attributes:
    
    
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#Byte'`
        - **Alias**: `class_iri`
    ...
    class_iri='https://w3id.org/emmo#Byte',
