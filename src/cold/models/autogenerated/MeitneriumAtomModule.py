...
class MeitneriumAtom(Declared, Atom):
    """
    Class representing the `MeitneriumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_3213514e_b1ba_506c_ae22_d4e3a688ddf3'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MeitneriumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_3213514e_b1ba_506c_ae22_d4e3a688ddf3',
    
    class_name='MeitneriumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_3213514e_b1ba_506c_ae22_d4e3a688ddf3',
        alias="class_iri"
    )
