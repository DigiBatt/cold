...
class ZincOxideElectrode(MetalOxideElectrode):
    """
    Class representing the `ZincOxideElectrode` entity, which inherits from:
    - MetalOxideElectrode
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_82c70935_0aea_454b_92bf_17fb0b488012'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ZincOxideElectrode'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = ZincOxideElectrode(
    
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_82c70935_0aea_454b_92bf_17fb0b488012',
    
    class_name='ZincOxideElectrode',
