...
class DubniumAtom(Declared, Atom):
    """
    Class representing the `DubniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_b65acde7_56c5_5cca_b589_b6744beb4223'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'DubniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_b65acde7_56c5_5cca_b589_b6744beb4223',
    
    class_name='DubniumAtom',
