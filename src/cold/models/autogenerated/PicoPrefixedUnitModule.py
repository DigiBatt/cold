...
class PicoPrefixedUnit(SIMetricSubMultipleUnit):
    """
    Class representing the `PicoPrefixedUnit` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_068c4e58_2470_4b1c_8454_010dd4906100'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PicoPrefixedUnit'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = PicoPrefixedUnit(
    
    class_iri='https://w3id.org/emmo#EMMO_068c4e58_2470_4b1c_8454_010dd4906100',
    
    class_name='PicoPrefixedUnit',
