...
class BromineAtom(Declared, Atom):
    """
    Class representing the `BromineAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_b3dfa085_5206_5868_b060_13efa01caf8e'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'BromineAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_b3dfa085_5206_5868_b060_13efa01caf8e',
    
    class_name='BromineAtom',
