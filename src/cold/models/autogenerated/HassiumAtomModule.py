...
class HassiumAtom(Declared, Atom):
    """
    Class representing the `HassiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_1acc07d0_709d_53f4_9807_cbc0d144865c'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'HassiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_1acc07d0_709d_53f4_9807_cbc0d144865c',
    
    class_name='HassiumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_1acc07d0_709d_53f4_9807_cbc0d144865c',
        alias="class_iri"
    )
