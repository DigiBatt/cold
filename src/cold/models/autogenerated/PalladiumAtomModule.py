...
class PalladiumAtom(Declared, Atom):
    """
    Class representing the `PalladiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_cabcb18d_88ff_5ff7_aceb_ab573526620e'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'PalladiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_cabcb18d_88ff_5ff7_aceb_ab573526620e',
    
    class_name='PalladiumAtom',
