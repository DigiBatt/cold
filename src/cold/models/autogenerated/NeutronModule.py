...
class Neutron(Nucleon):
    """
    Class representing the `Neutron` entity, which inherits from:
    - Nucleon
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_df808271_df91_4f27_ba59_fa423c51896c'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'Neutron'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_df808271_df91_4f27_ba59_fa423c51896c',
