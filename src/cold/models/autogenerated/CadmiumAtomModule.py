...
class CadmiumAtom(Declared, Atom):
    """
    Class representing the `CadmiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_0761710a_3de3_5cff_a0cc_dfb8eba5a99d'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CadmiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_0761710a_3de3_5cff_a0cc_dfb8eba5a99d',
    
    class_name='CadmiumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_0761710a_3de3_5cff_a0cc_dfb8eba5a99d',
        alias="class_iri"
    )
