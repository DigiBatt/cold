...
class KryptonAtom(Declared, Atom):
    """
    Class representing the `KryptonAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_72379870_0d00_5e48_912b_62cbd5b3f548'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'KryptonAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_72379870_0d00_5e48_912b_62cbd5b3f548',
    
    class_name='KryptonAtom',
