...
class DarmastadtiumAtom(Declared, Atom):
    """
    Class representing the `DarmastadtiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_5455d87d_1c98_50e1_9904_c94f6a697097'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'DarmastadtiumAtom'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = DarmastadtiumAtom(
    
    class_iri='https://w3id.org/emmo#EMMO_5455d87d_1c98_50e1_9904_c94f6a697097',
    
    class_name='DarmastadtiumAtom',
