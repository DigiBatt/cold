...
class ActiniumAtom(Declared, Atom):
    """
    Class representing the `ActiniumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_380f1ba6_b4f3_51e2_a63f_ceeeca2ed2f4'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'ActiniumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_380f1ba6_b4f3_51e2_a63f_ceeeca2ed2f4',
    
    class_name='ActiniumAtom',
