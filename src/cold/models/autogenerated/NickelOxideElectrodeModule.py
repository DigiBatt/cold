...
class NickelOxideElectrode(NickelBasedElectrode, MetalOxideElectrode):
    """
    Class representing the `NickelOxideElectrode` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo/domain/electrochemistry#electrochemistry_76e461aa_5948_4a68_8337_284d11e0fd7d'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'NickelOxideElectrode'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = NickelOxideElectrode(
    
    class_iri='https://w3id.org/emmo/domain/electrochemistry#electrochemistry_76e461aa_5948_4a68_8337_284d11e0fd7d',
    
    class_name='NickelOxideElectrode',
