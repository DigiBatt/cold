...
class IndiumAtom(Declared, Atom):
    """
    Class representing the `IndiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_96522455_d7d7_5b1e_b10a_ad87e41a5adc'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'IndiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_96522455_d7d7_5b1e_b10a_ad87e41a5adc',
    
    class_name='IndiumAtom',
