...
class CeriumAtom(Declared, Atom):
    """
    Class representing the `CeriumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_125b6f65_caf4_5ff2_89f2_90a6183ee34e'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'CeriumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_125b6f65_caf4_5ff2_89f2_90a6183ee34e',
    
    class_name='CeriumAtom',
    ...
    class_iri: Optional[str] = Field(
        'https://w3id.org/emmo#EMMO_125b6f65_caf4_5ff2_89f2_90a6183ee34e',
        alias="class_iri"
    )
