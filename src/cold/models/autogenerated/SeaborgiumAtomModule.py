...
class SeaborgiumAtom(Declared, Atom):
    """
    Class representing the `SeaborgiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_67eaac8f_7f83_5bca_b1d0_10451d3a88a1'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'SeaborgiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_67eaac8f_7f83_5bca_b1d0_10451d3a88a1',
    
    class_name='SeaborgiumAtom',
