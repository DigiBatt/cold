...
class HectoPascal(HectoPrefixedUnit, PressureUnit, SINonCoherentUnit, PrefixedUnit):
    """
    Class representing the `HectoPascal` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#HectoPascal'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'HectoPascal'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#HectoPascal',
    
    class_name='HectoPascal',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#HectoPascal',
