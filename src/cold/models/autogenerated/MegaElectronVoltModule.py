...
class MegaElectronVolt(PrefixedUnit, EnergyUnit):
    """
    Class representing the `MegaElectronVolt` entity, which inherits from:
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#MegaElectronVolt'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'MegaElectronVolt'`
        - **Alias**: `class_name`
    ...
    Example usage:
    ```python
    obj = MegaElectronVolt(
    
    class_iri='https://w3id.org/emmo#MegaElectronVolt',
    
    class_name='MegaElectronVolt',
    ...
    class_iri: Optional[str] = Field(
            ...
            'https://w3id.org/emmo#MegaElectronVolt',
