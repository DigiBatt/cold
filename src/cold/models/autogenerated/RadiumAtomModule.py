...
class RadiumAtom(Declared, Atom):
    """
    Class representing the `RadiumAtom` entity, which inherits from:
    - Declared, Atom
    ...
    - `class_iri` (`Optional[str]`): 
        - **Default Value**: `'https://w3id.org/emmo#EMMO_3ea9993c_80b9_5133_b552_dce78cd17ade'`
        - **Alias**: `class_iri`
    
    - `class_name` (`Optional[str]`): 
        - **Default Value**: `'RadiumAtom'`
        - **Alias**: `class_name`
    ...
    class_iri='https://w3id.org/emmo#EMMO_3ea9993c_80b9_5133_b552_dce78cd17ade',
    
    class_name='RadiumAtom',
